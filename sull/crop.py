...
source_dir=r'D:/project/project_face_age/sull/_data/11-15' # directory with files to crop
dest_dir=r'D:/project/project_face_age/sull/_crop/11-15' # directory where cropped images get stored
